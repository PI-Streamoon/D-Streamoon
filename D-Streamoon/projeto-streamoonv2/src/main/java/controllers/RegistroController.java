...
public class RegistroController {
    ...
    public void inserirDados() {
        ...
        registroModel.inserirDownload(Double.valueOf(redeEscolhida.getBytesEnviados()),componenteModel.pegarComponentePorNome("Download"));
        redeEscolhida.getBytesRecebidos();
